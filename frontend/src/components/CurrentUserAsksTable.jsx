...
import { useGetMyCurrentAsksQuery } from '../slices/usersApiSlice';

const CurrentUserAsksTable = ({ setSelectedSum }) => {
  const {
    data: currentAsks = [],
    isLoading,
    error,
  ...
  const columns = [
    ...
    columnHelper.accessor((row) => row.currentLowestAsk, {
      id: 'lowestAsk',
      header: 'Current Lowest Ask',
      cell: (info) => (
...
export default CurrentUserAsksTable;
